...
func (_m *Storage) CancelTransaction(ctx context.Context, txID string) error {
...
func (_m *Storage) GetTransaction(ctx context.Context, txID string) (*models.Transaction, error) {
	ret := _m.Called(ctx, txID)
